...
function chambeeion {
	...
	item replace entity @s armor.chest with minecraft:leather_chestplate{HideFlags:127,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],display:{color:16772608},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.01,Operation:0,UUID:[I;271273282,1400652759,-1615410207,238669607]}]}
...
function stinger {
	...
	item replace entity @s armor.chest with minecraft:leather_chestplate{HideFlags:127,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],display:{color:16772608},AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:0.02,Operation:0,UUID:[I;271273282,1400652759,-1615410207,238669607]}]}
...
function pollenator {
	...
	item replace entity @s armor.chest with minecraft:leather_chestplate{HideFlags:127,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],display:{color:16772608}}
	item replace entity @s armor.legs with minecraft:leather_leggings{HideFlags:127,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],display:{color:3022848}}
	item replace entity @s armor.feet with minecraft:leather_boots{HideFlags:127,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],display:{color:16772608}}

	item replace entity @s hotbar.0 with minecraft:stone_sword{HideFlags:127,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]}
	item replace entity @s hotbar.1 with minecraft:crossbow{HideFlags:127,Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:piercing",lvl:1s},{id:"minecraft:quick_charge",lvl:1s}]}
	item replace entity @s inventory.0 with minecraft:tipped_arrow{Potion:"minecraft:slow_falling"} 8
	item replace entity @s inventory.1 with minecraft:spectral_arrow 8
