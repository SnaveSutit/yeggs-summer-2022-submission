...
function reset {
	LOOP(['a','b'],team){
		...
		scoreboard players set #<%team%>.pollen_gen.amount v 20
		scoreboard players set #<%team%>.wax_gen.speed v 60
		scoreboard players set #<%team%>.wax_gen.amount v 12
		...
		scoreboard players set #<%team%>.hive.max_bees.honey_cost v 100
		scoreboard players set #<%team%>.hive.max_bees.wax_cost v 20
		...
		scoreboard players set #<%team%>.new_soldier.honey_cost v 5
		...
		scoreboard players set #<%team%>.hive.max_wax v 10
		scoreboard players set #<%team%>.hive.max_resources.honey_cost v 50
		scoreboard players set #<%team%>.hive.max_resources.wax_cost v 10
